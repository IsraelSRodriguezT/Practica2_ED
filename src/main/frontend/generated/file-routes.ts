...
import * as Page_3 from "../views/artista_banda-list.js";
import * as Page_4 from "../views/artista-list.js";
...
const routes: readonly AgnosticRoute_1[] = [
    createRoute_1("", Layout_1, [
        ...
        createRoute_1("artista_banda-list", Page_3),
        createRoute_1("artista-list", Page_4),
